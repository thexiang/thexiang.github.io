---
title: "Introduction to data week 2"
...
<li> <font color="red">No flight is delayed more than 2 hours.</font> </li> 
...
<li> <font color="red">Delta and United Airlines</font> </li>
...
sfo_feb_flights %>%
  group_by(carrier) %>%
  summarise(md_dd = median(arr_delay), iqr_dd = IQR(arr_delay))
```
...
<li> January </li> 
<li> March </li> 
<li> <font color="red">July</font> </li> 
<li> October </li>
<li> December </li>
</ol>
...
<li> July </li> 
<li> October </li>
<li> <font color="red">December</font> </li>
</ol>
...
<li> <font color="red">Median would be more reliable as the distribution of delays is skewed. </font></li> 
...
<ol>
<li> <font color="red">N666DN</font> </li> 
<li> N755US </li> 
<li> N779JB </li> 
<li> N947UW </li> 
<li> N959UW </li> 
...
<li> <font color="red">There is an overall postive association between distance and average speed.</font></li> 
...
length(a$flight)/length(b$flight)
```