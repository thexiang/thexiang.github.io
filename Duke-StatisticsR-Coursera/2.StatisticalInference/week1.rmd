...
<li> <font color="red"> 50\% of houses in Ames are smaller than 1,499.69 square feet.</font> </li>
...
samp1 %>%
  summarise(sample_mean = mean(area), pop_med = median(area), 
            sample_sd = sd(area), pop_iqr = IQR(area),
            pop_min = min(area), pop_max = max(area),
            pop_q1 = quantile(area, 0.25),  # first quartile, 25th percentile
            pop_q3 = quantile(area, 0.75))  # third quartile, 75th percentile
```
...
<li> <font color="red">Sample size of 1000.</font> </li>
</ol>
...
<ol>
<li> <font color="red">Each element represents a mean square footage from a simple random sample of 10 houses.</font> </li>
...
<ol>
<li> <font color="red">decreases</font> </li>
<li> increases </li>
...
<ol>
<li> <font color="red">The variability of the sampling distribution with the smaller sample size (`sample_means15`) is smaller than the variability of the sampling distribution with the larger sample size (`sample_means150`). </font></li>
